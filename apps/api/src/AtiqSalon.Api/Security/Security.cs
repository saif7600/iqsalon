...
{
    public static readonly string[] PlatformAll = ["platform.dashboard.read", "platform.tenants.read", "platform.plans.read", "platform.plans.manage", "platform.subscriptions.read", "platform.subscriptions.manage", "platform.billing.read", "platform.usage.read", "platform.entitlements.read", "platform.provisioning.read", "platform.support.read", "platform.operations.read", "platform.security.read", "platform.releases.read"];
